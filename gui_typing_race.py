...
class GuiTypingRace:
    ...
    def create_ui(self):
        pygame.init()
        pygame.display.set_caption(TITLE_TYPING_RACE)
        ...
        self.surfScores = pygame.Surface((WIDTH/2,HAUT_BORD_RECT))
        self.surfScores.fill((0,255,0))
        self.rectScores = self.surfScores.get_rect()
        self.rectScores.top = HEIGHT-HAUT_BORD_RECT
        self.rectScores.left = WIDTH/2
